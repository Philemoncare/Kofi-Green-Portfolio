  ...
  return (
    <div className="home">
      ...
      <section 
        className="hero"
        style={{
          backgroundImage: "url('./images/man.jpeg')",
        ...
        <div className="container">
          ...
          <div className="featured-grid">
            <div className="feature-card">
              <img src="/images/cabbage.jpeg" alt="Organic Cabbage" loading="lazy" />
              <h3>Organic Cabbage</h3>
              <p>Freshly harvested, pesticide-free organic cabbage.</p>
            </div>
            <div className="feature-card">
              <img src="/images/ingredient.jpeg" alt="Fresh Ingredients" loading="lazy" />
              <h3>Fresh Ingredients</h3>
              <p>Assorted fresh vegetables and herbs from our garden.</p>
            </div>
            <div className="feature-card">
              <img src="/images/logo.jpeg" alt="Goat Milk" loading="lazy" />
              <h3>Goat Milk</h3>
        ...
        <div className="container">
          <div className="about-content">
            ...
            <div className="about-image">
              <img src="/images/man.jpeg" alt="Kofi Green" loading="lazy" />
            </div>
          </div>
        </div>
      </section>
